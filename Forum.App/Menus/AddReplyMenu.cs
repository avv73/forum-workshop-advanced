namespace Forum.App.Menus
{
	...
	public class AddReplyMenu : Menu, ITextAreaMenu, IIdHoldingMenu
    {
        ...
        public AddReplyMenu(ILabelFactory labelFactory, ITextAreaFactory textAreaFactory, IForumReader reader,
            ICommandFactory commandFactory, IPostService postService, ISession session)
        {
        ...
        public override IMenu ExecuteCommand()
		{
            try
            {
                ...
                IMenu view = command.Execute(postId.ToString(), TextArea.Text, session.UserId.ToString());
